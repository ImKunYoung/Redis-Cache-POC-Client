...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="redisCachePocClientApp.productOrder.delete.question">
        <Translate contentKey="redisCachePocClientApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
