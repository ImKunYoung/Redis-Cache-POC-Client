  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="redisCachePocClientApp.productOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="redisCachePocClientApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('redisCachePocClientApp.productOrder.quantity')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.productOrder.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('redisCachePocClientApp.productOrder.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('redisCachePocClientApp.productOrder.cart')}
                type="select"
                required
              >
                <option value="" key="0" />
