...
export const ShoppingCartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="redisCachePocClientApp.shoppingCart.delete.question">
        <Translate contentKey="redisCachePocClientApp.shoppingCart.delete.question" interpolate={{ id: shoppingCartEntity.id }}>
