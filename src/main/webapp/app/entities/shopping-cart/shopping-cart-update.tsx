  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="redisCachePocClientApp.shoppingCart.home.createOrEditLabel" data-cy="ShoppingCartCreateUpdateHeading">
            <Translate contentKey="redisCachePocClientApp.shoppingCart.home.createOrEditLabel">Create or edit a ShoppingCart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('redisCachePocClientApp.shoppingCart.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.shoppingCart.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('redisCachePocClientApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('redisCachePocClientApp.shoppingCart.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.shoppingCart.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate('redisCachePocClientApp.PaymentMethod.' + paymentMethod)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('redisCachePocClientApp.shoppingCart.paymentReference')}
              ...
              <ValidatedField
                ...
                label={translate('redisCachePocClientApp.shoppingCart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
