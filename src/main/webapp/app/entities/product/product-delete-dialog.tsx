...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="redisCachePocClientApp.product.delete.question">
        <Translate contentKey="redisCachePocClientApp.product.delete.question" interpolate={{ id: productEntity.id }}>
