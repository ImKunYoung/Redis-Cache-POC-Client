...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="redisCachePocClientApp.customerDetails.delete.question">
        <Translate contentKey="redisCachePocClientApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
