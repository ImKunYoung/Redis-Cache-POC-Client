  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="redisCachePocClientApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="redisCachePocClientApp.customerDetails.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('redisCachePocClientApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate('redisCachePocClientApp.Gender.' + gender)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('redisCachePocClientApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('redisCachePocClientApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
