    ...
    <Row>
      <Col md="8">
        <h2 data-cy="customerDetailsDetailsHeading">
          <Translate contentKey="redisCachePocClientApp.customerDetails.detail.title">CustomerDetails</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="gender">
              <Translate contentKey="redisCachePocClientApp.customerDetails.gender">Gender</Translate>
            </span>
          </dt>
          <dd>{customerDetailsEntity.gender}</dd>
          <dt>
            <span id="phone">
              <Translate contentKey="redisCachePocClientApp.customerDetails.phone">Phone</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="city">
              <Translate contentKey="redisCachePocClientApp.customerDetails.city">City</Translate>
            </span>
          </dt>
          <dd>{customerDetailsEntity.city}</dd>
          <dt>
            <span id="country">
              <Translate contentKey="redisCachePocClientApp.customerDetails.country">Country</Translate>
            </span>
          </dt>
          <dd>{customerDetailsEntity.country}</dd>
          <dt>
            <Translate contentKey="redisCachePocClientApp.customerDetails.user">User</Translate>
          </dt>
