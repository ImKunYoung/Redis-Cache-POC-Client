...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="redisCachePocClientApp.productCategory.delete.question">
        <Translate contentKey="redisCachePocClientApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
