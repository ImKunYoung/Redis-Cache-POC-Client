  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="redisCachePocClientApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="redisCachePocClientApp.productCategory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('redisCachePocClientApp.productCategory.name')}
              ...
              />
              <ValidatedField
                label={translate('redisCachePocClientApp.productCategory.description')}
