...
describe('ProductOrder e2e test', () => {
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/products',
      body: {"name":"Personal","description":"Investment","price":9216,"productSize":"M","image":"Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci5wbmc=","imageContentType":"unknown"},
    }).then(({ body }) => {
      product = body;
    });
    // create an instance at the required relationship entity:
    cy.authenticatedRequest({
      ...
      body: {"placedDate":"2023-06-21T17:55:57.725Z","status":"PENDING","totalPrice":47349,"paymentMethod":"IDEAL","paymentReference":"Dollar navigating"},
    }).then(({ body }) => {
      shoppingCart = body;
    });
  });
