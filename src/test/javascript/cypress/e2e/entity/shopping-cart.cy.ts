...
describe('ShoppingCart e2e test', () => {
  ...
  // const shoppingCartSample = {"placedDate":"2023-06-21T12:13:34.162Z","status":"COMPLETED","totalPrice":33864,"paymentMethod":"CREDIT_CARD"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"gender":"MALE","phone":"044-6153-9869","addressLine1":"Belarus programming","addressLine2":"Fantastic","city":"East 민식구","country":"Cayman Islands"},
    }).then(({ body }) => {
  ...
  describe('new ShoppingCart page', () => {
    ...
    it.skip('should create an instance of ShoppingCart', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-06-22T05:45').blur().should('have.value', '2023-06-22T05:45');
